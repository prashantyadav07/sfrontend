...
const FloatingWhatsApp = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`bg-white text-gray-800 px-4 py-2 rounded-lg shadow-lg text-sm font-semibold transition-all duration-300 origin-right border border-gray-100 ${isHovered ? 'opacity-100 scale-100 translate-x-0' : 'opacity-0 scale-95 translate-x-4 pointer-events-none'
          }`}
      >
        Chat with us
      </div>
